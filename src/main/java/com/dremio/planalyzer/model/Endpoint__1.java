...
public class Endpoint__1 {
    ...
    public Endpoint__1 withAddress(String address) {
        this.address = address;
        return this;
    }
    ...
    public Endpoint__1 withFabricPort(long fabricPort) {
        this.fabricPort = fabricPort;
        return this;
    }
    ...
    public Endpoint__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Endpoint__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("address");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Endpoint__1) == false) {
            return false;
        }
        Endpoint__1 rhs = ((Endpoint__1) other);
